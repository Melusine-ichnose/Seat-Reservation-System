...
public class AdminController {
    ...
    public Map<String, Object> getViolationList() {
        List<Map<String, Object>> list = adminMapper.getViolationList();
        return new R().ok().add("rows", list).builder();
    }

    @GetMapping("/getSignRecordList")
    public Map<String, Object> getSignRecordList() {
        List<Map<String, Object>> list = adminMapper.getSignRecordList();
        return new R().ok().add("rows", list).builder();
    }

    @GetMapping("/getCreditLogList")
    public Map<String, Object> getCreditLogList() {
        List<Map<String, Object>> list = adminMapper.getCreditLogList();
        return new R().ok().add("rows", list).builder();
    }
