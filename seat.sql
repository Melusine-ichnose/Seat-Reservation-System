...
(15,1,1779154800000,1779197400000,100,0,NULL,10),
(16,3,1779154800000,1779197400000,101,0,NULL,NULL),
(17,1,1779210000000,1779247800000,61,-1,1779207742018,NULL),
(18,3,1779211800000,1779242400000,65,0,NULL,NULL),
(19,6,1779217200000,1779246000000,63,-1,NULL,NULL),
(20,9,1779219000000,1779237000000,69,0,NULL,NULL),
(21,10,1779228000000,1779246000000,72,0,NULL,NULL),
(22,10,1779237000000,1779238800000,70,1,1779236324628,NULL),
(24,10,1779238800000,1779240600000,58,-1,NULL,NULL),
(25,10,1779246000000,1779247800000,35,-1,1779245004527,NULL),
(26,1,1779064200000,1779082200000,35,-1,NULL,NULL),
(27,3,1779053400000,1779060600000,100,-1,NULL,NULL),
(28,1,1778942400000,1778949600000,101,-1,NULL,NULL),
(29,10,1778859600000,1778866800000,58,-1,NULL,NULL),
(30,6,1779064200000,1779082200000,35,-1,NULL,NULL),
(31,1,1779064200000,1779082200000,61,-1,NULL,NULL),
(32,1,1779064200000,1779082200000,35,-1,NULL,NULL),
(33,6,1779237000000,1779238800000,70,-1,NULL,NULL),
(34,6,1779253200000,1779253200000,72,-1,NULL,NULL);
...
CREATE TABLE `violation` (
  `vid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '违规记录编号',
  `rid` bigint(20) COMMENT '关联预约ID',
  `uid` bigint(20) COMMENT '用户ID',
  `type` int(11) COMMENT '违规类型：1未签到 2暂离超时',
  `deductScore` int(11) DEFAULT '10' COMMENT '扣除分数',
  `createTime` bigint(20) COMMENT '违规时间',
  PRIMARY KEY (`vid`),
  KEY `fk_violation_rid` (`rid`),
  KEY `fk_violation_uid` (`uid`),
  CONSTRAINT `fk_violation_rid` FOREIGN KEY (`rid`) REFERENCES `reservation` (`rid`),
  CONSTRAINT `fk_violation_uid` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`)
...
CREATE TABLE `sign_record` (
  `sid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '签到记录编号',
  `rid` bigint(20) COMMENT '关联预约ID',
  `uid` bigint(20) COMMENT '用户ID',
  `type` int(11) COMMENT '签到类型：1预约签到 2暂离返回',
  `signCode` varchar(20) COLLATE utf8mb4_unicode_ci COMMENT '使用的签到码',
  `createTime` bigint(20) COMMENT '签到时间',
  PRIMARY KEY (`sid`),
  KEY `fk_sign_rid` (`rid`),
  KEY `fk_sign_uid` (`uid`),
  CONSTRAINT `fk_sign_rid` FOREIGN KEY (`rid`) REFERENCES `reservation` (`rid`),
  CONSTRAINT `fk_sign_uid` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `credit_log` (
  `clid` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '日志编号',
  `uid` bigint(20) COMMENT '用户ID',
  `changeType` int(11) COMMENT '变动类型：1扣分 2加分',
  `changeScore` int(11) COMMENT '变动分数',
  `reason` varchar(200) COLLATE utf8mb4_unicode_ci COMMENT '变动原因',
  `operator` varchar(50) COLLATE utf8mb4_unicode_ci COMMENT '操作人',
  `createTime` bigint(20) COMMENT '操作时间',
  PRIMARY KEY (`clid`),
  KEY `fk_credit_uid` (`uid`),
  CONSTRAINT `fk_credit_uid` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
